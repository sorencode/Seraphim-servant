...
module.exports = {
    ...
    async execute(interaction, isButton = false) {
        ...
        logInfo(`[/uniform] Selected API Source: Waifu.im (tag: uniform)`);
        const imageData = await fetchWaifuIm('uniform', true);
