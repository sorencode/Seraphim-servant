...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('smothering')
        .setDescription('Delivers a random Smothering image'),
    async execute(interaction, isButton = false) {
        ...
        const endpoint = 'https://api.n-sfw.com/nsfw/smothering';
        logInfo(`[/smothering] Selected API Source: ABD (${endpoint})`);
        ...
        const embed = new EmbedBuilder()
            .setTitle('🔞 ▸ NSFW Smothering Image')
        ...
        const row = new ActionRowBuilder()
            .addComponents(
                new ButtonBuilder()
                    .setCustomId('refresh_smothering')
                    .setLabel('🔄 ▸ Refresh')
