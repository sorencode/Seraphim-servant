...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('socks')
        .setDescription('Delivers a random Socks image'),
    async execute(interaction, isButton = false) {
        ...
        const endpoint = 'https://api.n-sfw.com/nsfw/socks';
        logInfo(`[/socks] Selected API Source: ABD (${endpoint})`);
