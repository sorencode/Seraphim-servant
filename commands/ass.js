...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('ass')
        .setDescription('Delivers a random NSFW ass Image/GIF')
    ...
    async execute(interaction, isButton = false, savedStyle = null) {
        ...
        const animeSources = [ { id: 'abd', endpoint: 'https://api.n-sfw.com/nsfw/ass' }, { id: 'waifuim', tag: 'ass' }, { id: 'nekobot', type: 'hass' } ];
        const realSources = [ { id: 'obutts' }, { id: 'nekobot', type: 'ass' } ];
        ...
        const customIdBase = style ? `refresh_ass_${style}` : `refresh_ass`;
