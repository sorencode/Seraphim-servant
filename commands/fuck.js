...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('fuck')
        .setDescription('Delivers a random penetrative sex GIF'),
    async execute(interaction, isButton = false) {
        ...
        const endpoint = 'https://purrbot.site/api/img/nsfw/fuck/gif';
