...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('breeding')
        .setDescription('Delivers a random Breeding image'),
    async execute(interaction, isButton = false) {
        ...
        logInfo(`[/breeding] Selected API Source: ABD (${endpoint})`);
