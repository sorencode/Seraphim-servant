...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('cum')
        .setDescription('Delivers a random cum/ejaculation GIF'),
    async execute(interaction, isButton = false) {
        ...
        const endpoint = 'https://purrbot.site/api/img/nsfw/cum/gif';
