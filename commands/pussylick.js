...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('pussylick')
        .setDescription('Delivers a random cunnilingus GIF'),
    async execute(interaction, isButton = false) {
        ...
        const endpoint = 'https://purrbot.site/api/img/nsfw/pussylick/gif';
