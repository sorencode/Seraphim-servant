...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('petgirls')
        .setDescription('Delivers a random Petgirls image'),
    async execute(interaction, isButton = false) {
        ...
        const endpoint = 'https://api.n-sfw.com/nsfw/petgirls';
        logInfo(`[/petgirls] Selected API Source: ABD (${endpoint})`);
