...
module.exports = {
    ...
    async execute(interaction, isButton = false, savedStyle = null) {
        ...
        const customIdBase = style ? `refresh_anal_${style}` : `refresh_anal`;
