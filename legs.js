...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('legs')
        .setDescription('Delivers a random Legs image'),
    async execute(interaction, isButton = false) {
        ...
        const endpoint = 'https://api.n-sfw.com/nsfw/legs';
        logInfo(`[/legs] Selected API Source: ABD (${endpoint})`);
